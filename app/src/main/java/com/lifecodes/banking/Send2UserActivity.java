...
public class Send2UserActivity extends AppCompatActivity {

    List<Model> modelList_sendtouser = new ArrayList<>();
    RecyclerView mRecyclerView;
    RecyclerView.LayoutManager layoutManager;
    AdapterSend2User adapter;
    ...
    private void showData(String phonenumber) {
        ...
        adapter = new AdapterSend2User(Send2UserActivity.this, modelList_sendtouser);
    ...
    public void selectuser(int position) {
       selectuser_phonenumber = modelList_sendtouser.get(position).getPhoneno();
        ...
        while(cursor.moveToNext()) {
            ...
            startActivity(new Intent(Send2UserActivity.this, UserListActivity.class));
            finish();
        }
    }
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(Send2UserActivity.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        new DatabaseHelper(Send2UserActivity.this).insertTransferData(date, name, "Not selected", transferamount, "Failed");
                        Toast.makeText(Send2UserActivity.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(Send2UserActivity.this, UserListActivity.class));
                        finish();
                    }
