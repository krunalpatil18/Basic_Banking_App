...
public class UserListActivity extends AppCompatActivity {
    ...
    private void showData() {
        ...
        adapter = new AdapterUserList(UserListActivity.this, modelList_showlist);
        mRecyclerView.setAdapter(adapter);
    }

    public void nextActivity(int position) {
        phonenumber = modelList_showlist.get(position).getPhoneno();
        Intent intent = new Intent(UserListActivity.this, UserData.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId()==R.id.action_history){
            startActivity(new Intent(UserListActivity.this, TransferHistory.class));
        }
