...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.lifecodes.banking.ViewHolder.ClickListener mClickListener;
    public interface  ClickListener{
        void onItemClick(View view, int position);
    }

    public void setOnClickListener(com.lifecodes.banking.ViewHolder.ClickListener clickListener){
